...
var Stats = function(props) {
    if(props.stats.status !== 'error' || props.stats === undefined){
        ...
        let rankStyles = {
            height: '100px',
            width: '100px',
            background: `url("https://www.callofduty.com/cdn/app/icons/mw/ranks/mp/icon_rank_${props.stats.data.level}.png")`,
        ...
        return (
            ...
            <div id="playerStats">
                ...
                <div id="level">
                    <div id="levelText">LEVEL {props.stats.data.level} </div>
